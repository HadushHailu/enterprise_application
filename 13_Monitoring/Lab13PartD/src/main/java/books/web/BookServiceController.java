...
public class BookServiceController {
	...
	@PostMapping(value = "/books", consumes = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE}, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<?> addContact(@Valid @RequestBody Book book) {
        System.out.println("POST executed: " + book);
